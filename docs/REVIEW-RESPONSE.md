...
| R31 | Some files are far too big (~1,700 lines) | ⬜ | **Not started.** `StudentDashboard.tsx` 2,428, `DeveloperDashboard.tsx` 1,836, `OrgDashboard.tsx` 1,552. Larger than he estimated. Planned for v1.1 |
