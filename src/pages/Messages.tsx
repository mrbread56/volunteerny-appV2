...
export default function Messages() {
  ...
  if (isDemoMode) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <h1 className="text-2xl font-semibold text-ink mb-2">Messages</h1>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="bg-white border border-line rounded-lg overflow-hidden flex h-[75vh] min-h-[480px]">
        {/* Chat list */}
        <div
          className={cn(
            "w-full sm:w-[320px] shrink-0 border-r border-line flex flex-col bg-paper-2/50",
            activeChatId ? "hidden sm:flex" : "flex"
          )}
        >
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            {chats.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-ink-muted space-y-4 px-6 text-center">
        ...
        <div className={cn("flex-1 flex flex-col min-w-0", activeChatId ? "flex" : "hidden sm:flex")}>
          {!activeChat ? (
            ...
            <>
              <div className="bg-slate-900 text-white px-4 py-3 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-2 min-w-0">
                  <button
                    ...
                    className="p-1 hover:bg-slate-800 rounded-lg transition-colors sm:hidden"
                  >
                    <ChevronLeft className="w-5 h-5" />
                  </button>
                  <div className="min-w-0">
                    <h3 className="font-semibold tracking-wide truncate">{chatTitle(activeChat)}</h3>
                ...
                <button
                  ...
                  className="p-2 text-ink-muted hover:text-red-400 transition-colors shrink-0"
              ...
              <div className="flex-1 bg-paper-2 overflow-y-auto p-4 space-y-3">
                {messages.map((msg, i) => {
                        ...
                        {msg.attachmentUrl && !msg.attachmentIsPdf && (
                          <a href={msg.attachmentUrl} target="_blank" rel="noopener noreferrer">
                            <img
                              ...
                              alt="attachment"
                              className="mt-2 rounded-lg max-w-full h-auto max-h-[220px] object-cover"
                            />
                          </a>
                        )}
                      </div>
              ...
              <div className="p-3 bg-white border-t border-line flex items-center gap-2 shrink-0">
