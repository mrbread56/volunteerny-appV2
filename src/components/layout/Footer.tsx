        ...
        <div className="py-20 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link to="/signup" className="inline-block py-1.5 text-xs text-paper/75 hover:text-paper transition-colors duration-200">Browse Opportunities</Link></li>
              <li><Link to="/signup" className="inline-block py-1.5 text-xs text-paper/75 hover:text-paper transition-colors duration-200">Join as Organisation</Link></li>
              <li><Link to="/login" className="inline-block py-1.5 text-xs text-paper/75 hover:text-paper transition-colors duration-200">Sign In</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            {/* Tighter than it looks: the links below carry py-1.5, so the
                ...
                itself — which is hard to hit accurately on a phone. */}
            <ul className="space-y-1">
              <li><Link to="/terms" className="inline-block py-1.5 text-xs text-paper/75 hover:text-paper transition-colors duration-200">Terms of Service</Link></li>
              <li><Link to="/privacy" className="inline-block py-1.5 text-xs text-paper/75 hover:text-paper transition-colors duration-200">Privacy Policy</Link></li>
            </ul>
          </div>
        </div>
