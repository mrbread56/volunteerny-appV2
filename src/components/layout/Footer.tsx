    ...
    <footer className="bg-gradient-to-b from-[#1F2E38] to-[#1A2830] text-paper/80 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="py-20 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          {/* Product */}
          <div>
            <h4 className="text-xs font-semibold tracking-[0.1em] uppercase text-paper/20 mb-5">Product</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-xs font-semibold tracking-[0.1em] uppercase text-paper/20 mb-5">Support</h4>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-xs font-semibold tracking-[0.1em] uppercase text-paper/20 mb-5">Legal</h4>
            <ul className="space-y-3">
