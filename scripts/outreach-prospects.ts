...
export const PROSPECTS: Prospect[] = [
  ...
  { org: 'Toronto Humane Society', email: 'volunteer@torontohumanesociety.com', area: 'Toronto', fit: 'check-age',
    note: 'Very popular with students. Shelters often set 16 or 18.' },
  ...
  { org: 'WoodGreen Community Services', email: 'volunteer@woodgreen.org', area: 'East Toronto', fit: 'ok',
    note: 'Refused 5.7.1 twice on 7 Sep, through two different API clients minutes apart, while sixteen other recipients accepted mail the same evening. Recipient-side rejection, not our quota. Phone (416) 645-6000 ext 5235 before trying a third time.' },
